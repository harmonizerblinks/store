                ...
                <form class="form p-t-20" method="post" action="logs/addproducts.php" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="sales_id" value="<?php echo "ITM".date('mdhis'); ?>" required readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="items_name" placeholder="Purchase Price" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="mdi mdi-currency-eur"></i></div>
                            <input type="number" class="form-control" name="unitprice" placeholder="Sales Price" required>
                        </div>
                    </div>
